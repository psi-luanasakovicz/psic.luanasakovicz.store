      ...
      <section id="benefits" className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-6">
            <span className="text-xs font-semibold uppercase tracking-[0.2em] text-[#8A645D]/80 bg-[#ECE9E8] px-3.5 py-1.5 rounded-full">
              Diferenciais
            </span>
            ...
            <div className="space-y-4 pt-4">
              <div className="flex gap-4 items-start">
                ...
                <div>
                  ...
                  <p className="text-xs text-[#8A645D]/75 mt-1">
          ...
          <div className="bg-[#ECE9E8] border border-[#D4C6C2] rounded-[2.5rem] p-8 space-y-6 shadow-inner relative overflow-hidden">
            ...
            <div className="bg-[#F3F1F0] p-6 rounded-2xl border border-[#D4C6C2]/60 shadow-sm space-y-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[10px] uppercase font-bold tracking-wider text-[#8A645D]/60">
                  Feedback Recente
                </span>
              </div>
              ...
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-full bg-[#8A645D]/25 flex items-center justify-center text-[10px] font-bold">
                  ML
                </div>
                <div>
            ...
            <div className="bg-[#F3F1F0] p-6 rounded-2xl border border-[#D4C6C2]/60 shadow-sm space-y-2 max-w-sm ml-auto">
              ...
              <p className="text-xs font-bold text-[#8A645D]">
